...
from ..models import (SavedSyncInfo, EditedPasswordEntryInfo, EditedEntryWithGroup)
...
class PasswordEntryMethods:
    ...
    def create_entry(
        ...
        api_data: api_models.EntryPublicGet = api_create_entry.sync(
