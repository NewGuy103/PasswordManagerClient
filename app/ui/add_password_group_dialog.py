...
from PySide6.QtWidgets import QDialogButtonBox, QFormLayout, QFrame, QLabel, QLineEdit, QVBoxLayout


class Ui_AddPasswordGroupDialog:
    def setupUi(self, AddPasswordGroupDialog):
        if not AddPasswordGroupDialog.objectName():
            AddPasswordGroupDialog.setObjectName("AddPasswordGroupDialog")
    ...
    def retranslateUi(self, AddPasswordGroupDialog):
        AddPasswordGroupDialog.setWindowTitle(
            QCoreApplication.translate("AddPasswordGroupDialog", "PasswordManager - Add password group", None)
        )
        self.groupNameLabel.setText(QCoreApplication.translate("AddPasswordGroupDialog", "Group Name:", None))
