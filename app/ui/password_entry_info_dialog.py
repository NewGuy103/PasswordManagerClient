...
class Ui_PasswordEntryInfoDialog:
    def setupUi(self, PasswordEntryInfoDialog):
        if not PasswordEntryInfoDialog.objectName():
            PasswordEntryInfoDialog.setObjectName("PasswordEntryInfoDialog")
    ...
    def retranslateUi(self, PasswordEntryInfoDialog):
        PasswordEntryInfoDialog.setWindowTitle(
            QCoreApplication.translate("PasswordEntryInfoDialog", "PasswordManager - Password entry info", None)
        )
        self.titleLabel.setText(QCoreApplication.translate("PasswordEntryInfoDialog", "Title:", None))
        self.usernameLabel.setText(QCoreApplication.translate("PasswordEntryInfoDialog", "Username:", None))
        self.passwordLabel.setText(QCoreApplication.translate("PasswordEntryInfoDialog", "Password:", None))
        self.urlLabel.setText(QCoreApplication.translate("PasswordEntryInfoDialog", "URL:", None))
        self.urlLineEdit.setPlaceholderText(
            QCoreApplication.translate("PasswordEntryInfoDialog", "https://example.com", None)
        )
        self.notesLabel.setText(QCoreApplication.translate("PasswordEntryInfoDialog", "Notes:", None))
